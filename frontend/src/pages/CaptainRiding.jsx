  ...
  return (
    <div className="h-screen relative">
      ...
      <div
        ...
        className="h-1/5 flex items-center justify-between bg-yellow-400 p-6 relative"
      >
        <h5
          onClick={() => {}}
      ...
      <div
        ...
        className=" fixed w-full h-[85%] z-10 bottom-0 translate-y-full  bg-white px-3 py-10 pt-12"
      >
